# RailsAdmin config file. Generated on November 06, 2012 17:01
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Wedding Prototype', 'Admin']
  ...
  # config.excluded_models = ['Event', 'Invitation', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Event', 'Invitation', 'User']
  ...
  #     configure :scheduled_date, :datetime 
  ...
  #     configure :display_name, :string 
  #     configure :inactive_at, :datetime 
